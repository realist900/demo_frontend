...
class _$RegisterRequestImpl extends _RegisterRequest {
  ...
  @override
  String toString() {
    return 'RegisterRequest(login: $login, password: $password, name: $name, email: $email)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, login, password, name, email);
...
abstract class _RegisterRequest extends RegisterRequest {
  const factory _RegisterRequest(
      ...
      @JsonKey(name: 'email') final String email}) = _$RegisterRequestImpl;
